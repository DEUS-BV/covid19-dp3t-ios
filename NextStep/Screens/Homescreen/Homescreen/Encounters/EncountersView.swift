...
class EncountersView: NSModuleBaseView {
    var uiState: NSUIStateModel.Homescreen.Begegnungen.Tracing = .active {
        didSet { updateUI() }
    }

    private let tracingActiveView = NSBluetoothSettingsDetailView(title: "tracing_active_title".ub_localized, subText: "tracing_active_text".ub_localized, image: nil, titleColor: .ns_secondary, subtextColor: .ns_text)
    private let tracingInactiveView = NSBluetoothSettingsDetailView(title: "tracing_error_title".ub_localized, subText: "tracing_error_text".ub_localized, image: nil, titleColor: .ns_error, subtextColor: .ns_error)
